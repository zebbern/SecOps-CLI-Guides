...
version: 1.0.0
tags: [ssh, penetration-testing, brute-force, tunneling, enumeration, security]
---
...
3. Confirm key permissions (600 for private keys)
4. Check authorized_keys format

### Tunnel Not Working

**Solutions:**
1. Verify GatewayPorts in sshd_config
2. Check AllowTcpForwarding setting
3. Confirm no firewall blocking
4. Test with verbose mode: `ssh -v`
