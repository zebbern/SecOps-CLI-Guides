...
version: 1.0.0
tags: [xss, cross-site-scripting, html-injection, web-security, client-side-attacks, input-validation]
---
...
- Cookie exfiltration logs (sanitized)
- Payload effectiveness documentation
